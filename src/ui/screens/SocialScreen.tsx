...
function ShowmatchesTab() {
  ...
  function handleAccept() {
    ...
    startTournamentSeries(self, [invite.opponentName], streamer?.seriesFormat ?? 5, era, s.seasonNumber, s.currentDate.year, s.currentDate, s.seasonStartDate, (wonSeries) => {
